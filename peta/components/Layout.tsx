...
export default function Layout({ children }: LayoutProps) {
  ...
  // Don't render navigation until features and config are loaded
  if (loading || configLoading || !siteConfig) {
    return (
      ...
      <footer className={styles.footer}>
        <div className={styles.footerContent}>
          <p className={styles.footerText}>
            {siteConfig.footer.customText || siteConfig.footer.copyright}
          </p>
